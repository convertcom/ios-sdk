// Tests/ConvertSwiftSDKTests/ConvertContextRunFeaturesTests.swift
...
// EXISTING public surface (`ConvertSwiftSDK(...)`, `ready()`, `createContext`, `runFeature`,
...
// `ConvertSwiftSDK` wires its OWN internal `EventSink` behind `FeatureManager` (which itself delegates
...
struct ConvertContextRunFeaturesTests {
    ...
    private func makePreReadySDK() -> ConvertSwiftSDK {
        ConvertSwiftSDK(
