// Tests/ConvertSwiftSDKTests/SegmentationTests.swift
...
struct SegmentationTests {
    ...
    /// config) and the AC11 audience-gated case share ONE `ConvertSwiftSDK(...)` + `ready()` build (SonarQube 3%
    ...
    private func countSegments(on sdk: ConvertSwiftSDK) async -> (box: LockedBox<Int>, token: EventListenerToken) {
