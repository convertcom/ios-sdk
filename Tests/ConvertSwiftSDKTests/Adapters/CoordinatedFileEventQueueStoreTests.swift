// Tests/ConvertSwiftSDKTests/Adapters/CoordinatedFileEventQueueStoreTests.swift
import Testing
import Foundation
...
// `Sources/ConvertSwiftSDK/Adapters/CoordinatedFileEventQueueStore.swift`. Until then this file
