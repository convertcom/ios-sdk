// Tests/ConvertSwiftSDKTests/Adapters/BackgroundUploadDelegateTests.swift
import Testing
import Foundation
...
// `Sources/ConvertSwiftSDK/Adapters/BackgroundUploadDelegate.swift`. Until then this file fails to
