// Tests/ConvertSwiftSDKTests/Adapters/KeychainSecureStoreTests.swift
import Testing
import Foundation
...
// `Sources/ConvertSwiftSDK/Adapters/KeychainSecureStore.swift`. Until then this file fails
