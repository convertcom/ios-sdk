// Tests/ConvertSwiftSDKTests/Support/TestFixtures.swift
//
...
// creates `actor ConfigRefreshScheduler` at `Sources/ConvertSwiftSDK/Lifecycle/ConfigRefreshScheduler.swift`),
...
/// `ConvertSwiftSDKTests.makeConfig`; `ProjectConfig` decodes field-by-field and never throws on this
...
///
/// Named `makeRefreshConfig` (not `makeValidConfig`) ON PURPOSE: `ConvertSwiftSDKTests.swift` already
...
/// merely non-nil. Re-declared here (not reaching `ConvertSwiftSDKCoreTests`' identical `ProjectConfigFixtures`,
...
///
/// Re-declared here (not reaching `ConvertSwiftSDKCoreTests`' `ProjectConfigFixtures`, which compiles into
...
///
/// Re-declared here (not reaching `ConvertSwiftSDKCoreTests`' `ProjectConfigFixtures.goalJSON`, which compiles
...
/// `EventBusTests` / `ConfigStoreTests` / `ConvertSwiftSDKTests`.
