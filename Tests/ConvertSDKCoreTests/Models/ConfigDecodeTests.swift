// Tests/ConvertSDKCoreTests/Models/ConfigDecodeTests.swift
import Foundation
import Testing
...
/// emitted, committed under `Tests/ConvertSDKCoreTests/Fixtures/`:
...
struct ConfigDecodeTests {
    ...
    /// `resources: [.copy("Fixtures")]` on the `ConvertSDKCoreTests` target in Package.swift,
