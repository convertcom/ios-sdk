// Tests/ConvertSwiftSDKCoreTests/Bucketing/BucketingManagerTests.swift
...
// scope") until the GREEN phase lands `Sources/ConvertSwiftSDKCore/Bucketing/BucketingManager.swift`.
