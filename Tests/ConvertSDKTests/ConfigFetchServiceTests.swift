// Tests/ConvertSDKTests/ConfigFetchServiceTests.swift
//
...
// creates it at `Sources/ConvertSDK/ConfigFetchService.swift`. Until then this file
...
final class ConfigFetchServiceTests {
    ...
    /// Constructed locally (NOT the ConvertSDKCoreTests baseline fixture — wrong target).
