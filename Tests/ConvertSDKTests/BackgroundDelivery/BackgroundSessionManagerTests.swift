// Tests/ConvertSDKTests/BackgroundDelivery/BackgroundSessionManagerTests.swift
import Testing
import Foundation
...
// YET — the GREEN step creates it at `Sources/ConvertSDK/BackgroundDelivery/BackgroundSessionManager.swift`.
