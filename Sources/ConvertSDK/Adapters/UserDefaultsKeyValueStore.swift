...
// other lightweight string values) into `UserDefaults`. Lives in the `ConvertSDK`
...
/// annotation `LockedBox` and `ConvertSDK.shared` use, and the architecture's accepted
