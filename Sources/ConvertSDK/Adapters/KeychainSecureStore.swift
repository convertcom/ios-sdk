...
// Keychain via the Security framework. Lives in the `ConvertSDK` (platform) target
// because it links Security; the pure-logic `ConvertSDKCore` must NOT import it — the
