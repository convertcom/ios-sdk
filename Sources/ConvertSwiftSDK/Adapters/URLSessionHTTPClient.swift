...
// `ConvertSwiftSDK` target because it depends on Foundation networking; the port it
// conforms to is Foundation-only and lives in the pure-logic `ConvertSwiftSDKCore`.
