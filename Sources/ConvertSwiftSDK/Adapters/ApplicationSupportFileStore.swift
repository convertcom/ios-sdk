...
// `ConvertSwiftSDK` (platform) target because it depends on Foundation file I/O via
// `CoordinatedFileStore`; the pure-logic `ConvertSwiftSDKCore` must NOT import it.
